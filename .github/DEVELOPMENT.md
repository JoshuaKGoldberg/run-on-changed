...
```shell
git clone https://github.com/(your-name-here)/run-on-changed
cd run-on-changed
pnpm install
```
...
Note that [console-fail-test](https://github.com/getsentry/console-fail-test) is enabled for all test runs.
